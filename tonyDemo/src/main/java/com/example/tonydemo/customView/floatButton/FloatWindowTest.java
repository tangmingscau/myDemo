...
import com.example.tonydemo.MainActivity;
import com.example.tonydemo.R;

public class FloatWindowTest extends AppCompatActivity
{  
    ...
    {  
        ...
        mFloatLayout = (LinearLayout) inflater.inflate(R.layout.float_customview, null);
        ...
        {  
            ...
            {  
                // TODO Auto-generated method stub  
                Intent intent = new Intent(FloatWindowTest.this, MainActivity.class);
